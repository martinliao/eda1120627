...
//for eda
if (!$DB->record_exists('my_pages', array('userid' => $USER->id, 'private' => MY_PAGE_PRIVATE))) {
    my_copy_page($USER->id, MY_PAGE_PRIVATE);
    $mytoctab  = optional_param('mytoctab', '', PARAM_TEXT);
    redirect(new moodle_url('/my', array('mytoctab'=>$mytoctab)));
}
